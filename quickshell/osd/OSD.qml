          ...
          ColumnLayout {
            ...
            Rectangle {
              ...
              Rectangle {
                ...
                radius: 3
                color: root.volumeMuted ? root.theme.overlay0 : root.theme.green
            ...
            Text {
	      text: {
		if (root.volumeMuted) return "󰸈";
                if (root.volumeValue <= 0) return "";
                if (root.volumeValue < 0.33) return "";
                if (root.volumeValue < 0.66) return "";
                return "";
              }
              color: root.volumeMuted ? root.theme.overlay0 : root.theme.green
              font.pixelSize: 15
